...
describe('renderAgentsMarkdown', () => {
  it('renders the complete public contract for agents', () => {
    ...
    expect(markdown).toContain('NABU_AGENT_TOKEN')
    expect(markdown).toContain('POST https://nabu.timi.click/api/agent/connections/redeem')
    expect(markdown).toContain('AGENT_CONNECTION_INVALID')
